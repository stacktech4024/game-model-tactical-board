...
export const SET_PIECES_PAGE_CASES: SetPiecePageCase[] = [
  {
    ...
    strategy: 'Use a legal short-angle trigger and connected far-side manipulation to release diagonal runs at #9’s central target, then attack the next contact to finish.',
    tactics: [
      ...
      '#9 attacks the selected central delivery while the hybrid defence and goalkeeper contest first contact',
      '#8 steps through the second action and strikes through traffic while #2/#6 protect the transition',
    ],
    ...
    caption: 'Short-angle trigger, connected far-side cluster, diagonal three-zone runs, contested first contact, and a decisive second-action finish.',
