...
const zone1Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-9', to: { x: 53, y: 28 }, startDelay: 0.05 },
      { playerId: 'away-11', to: { x: 25, y: 39 }, startDelay: 0.1 },
      { playerId: 'away-6', to: { x: 43, y: 53 }, startDelay: 0.14 },
      { playerId: 'away-3', to: { x: 28, y: 74 }, startDelay: 0.2 },
      { playerId: 'away-4', to: { x: 42, y: 72 }, startDelay: 0.26 },
    ],
    duration: 0.42,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 58, y: 32 }, startDelay: 0.05 },
      { playerId: 'away-7', to: { x: 73, y: 37 }, startDelay: 0.1 },
      { playerId: 'away-5', to: { x: 60, y: 70 }, startDelay: 0.18 },
      { playerId: 'away-2', to: { x: 74, y: 72 }, startDelay: 0.26 },
    ],
    duration: 0.42,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-7', to: { x: 72, y: 34 }, startDelay: 0.05 },
      { playerId: 'away-6', to: { x: 45, y: 34 }, startDelay: 0.1 },
      { playerId: 'away-8', to: { x: 59, y: 31 }, startDelay: 0.14 },
      { playerId: 'away-4', to: { x: 45, y: 64 }, startDelay: 0.2 },
      { playerId: 'away-5', to: { x: 60, y: 64 }, startDelay: 0.28 },
    ],
    duration: 0.5,
  },
  {
  ...
  },
  {
    ...
    cue: 'Cover and BALANCE — #6/#8 protect goal-side as #10/#9 recover into separate screens.',
    playerMoves: [
      { playerId: 'home-6', to: { x: 45, y: 25 } },
      { playerId: 'home-8', to: { x: 57, y: 27 }, startDelay: 0.06 },
      { playerId: 'home-10', to: { x: 50, y: 46 }, startDelay: 0.12 },
      { playerId: 'home-9', to: { x: 61, y: 55 }, startDelay: 0.18 },
    ],
    duration: 0.46,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-4', to: { x: 42, y: 16 }, startDelay: 0.04 },
      { playerId: 'home-2', to: { x: 71, y: 20 }, startDelay: 0.08 },
      { playerId: 'home-1', to: { x: 50, y: 7 }, startDelay: 0.12 },
    ],
    duration: 0.3,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 58, y: 37 }, startDelay: 0.02 },
      { playerId: 'away-4', to: { x: 44, y: 69 }, startDelay: 0.04 },
      { playerId: 'away-5', to: { x: 59, y: 69 }, startDelay: 0.06 },
      { playerId: 'away-3', to: { x: 30, y: 71 }, startDelay: 0.08 },
      { playerId: 'away-2', to: { x: 74, y: 71 }, startDelay: 0.1 },
    ],
    duration: 0.26,
  },
]
...
const zone2Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-9', to: { x: 51, y: 34 }, startDelay: 0.05 },
      { playerId: 'away-7', to: { x: 76, y: 54 }, startDelay: 0.1 },
      { playerId: 'away-3', to: { x: 28, y: 75 }, startDelay: 0.18 },
      { playerId: 'away-4', to: { x: 42, y: 73 }, startDelay: 0.26 },
    ],
    duration: 0.42,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 57, y: 42 }, startDelay: 0.06 },
      { playerId: 'away-11', to: { x: 25, y: 53 }, startDelay: 0.12 },
      { playerId: 'away-5', to: { x: 59, y: 70 }, startDelay: 0.18 },
      { playerId: 'away-2', to: { x: 73, y: 70 }, startDelay: 0.26 },
    ],
    duration: 0.42,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-7', to: { x: 75, y: 48 }, startDelay: 0.05 },
      { playerId: 'away-6', to: { x: 42, y: 47 }, startDelay: 0.1 },
      { playerId: 'away-8', to: { x: 59, y: 45 }, startDelay: 0.14 },
      { playerId: 'away-4', to: { x: 45, y: 63 }, startDelay: 0.2 },
      { playerId: 'away-5', to: { x: 60, y: 63 }, startDelay: 0.28 },
    ],
    duration: 0.5,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-7', to: { x: 70, y: 55 }, startDelay: 0.08 },
      { playerId: 'home-9', to: { x: 50, y: 58 }, startDelay: 0.14 },
      { playerId: 'home-11', to: { x: 30, y: 55 }, startDelay: 0.2 },
    ],
    duration: 0.46,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-4', to: { x: 42, y: 30 }, startDelay: 0.04 },
      { playerId: 'home-2', to: { x: 70, y: 35 }, startDelay: 0.08 },
      { playerId: 'home-3', to: { x: 30, y: 35 }, startDelay: 0.12 },
      { playerId: 'home-1', to: { x: 50, y: 7 }, startDelay: 0.14 },
    ],
    duration: 0.3,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 59, y: 49 }, startDelay: 0.02 },
      { playerId: 'away-4', to: { x: 44, y: 69 }, startDelay: 0.04 },
      { playerId: 'away-5', to: { x: 59, y: 69 }, startDelay: 0.06 },
      { playerId: 'away-3', to: { x: 30, y: 71 }, startDelay: 0.08 },
      { playerId: 'away-2', to: { x: 73, y: 71 }, startDelay: 0.1 },
    ],
    duration: 0.26,
  },
]
...
const zone3Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-7', to: { x: 57, y: 42 }, startDelay: 0.08 },
      { playerId: 'away-4', to: { x: 43, y: 75 }, startDelay: 0.18 },
      { playerId: 'away-3', to: { x: 28, y: 76 }, startDelay: 0.22 },
    ],
    duration: 0.38,
  },
  {
    id: 'zone-3-five-to-six',
    cue: 'Canada buildup — #5 connects with #6 as the ball-side defenders narrow in layers.',
    ...
    playerMoves: [
      ...
      { playerId: 'away-9', to: { x: 37, y: 35 }, startDelay: 0.08 },
      { playerId: 'away-5', to: { x: 59, y: 73 }, startDelay: 0.18 },
      { playerId: 'away-2', to: { x: 68, y: 73 }, startDelay: 0.24 },
    ],
    duration: 0.4,
  },
  {
    ...
    playerTo: { x: 46, y: 58 },
    playerMoves: [
      { playerId: 'away-2', to: { x: 66, y: 67 } },
      { playerId: 'away-8', to: { x: 54, y: 57 }, startDelay: 0.08 },
      { playerId: 'away-7', to: { x: 60, y: 40 }, startDelay: 0.14 },
      { playerId: 'away-5', to: { x: 61, y: 69 }, startDelay: 0.22 },
    ],
    duration: 0.4,
  },
  {
    id: 'zone-3-loss',
    cue: 'Zone 3 loss — away #2 steps from the compact line to intercept Canada’s wide supply pass.',
    ...
    playerTo: { x: 64, y: 63 },
    playerMoves: [
      { playerId: 'away-5', to: { x: 58, y: 66 }, startDelay: 0.08 },
      { playerId: 'away-4', to: { x: 47, y: 67 }, startDelay: 0.14 },
      { playerId: 'away-3', to: { x: 32, y: 68 }, startDelay: 0.22 },
    ],
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 55, y: 51 }, startDelay: 0.06 },
      { playerId: 'away-6', to: { x: 43, y: 56 }, startDelay: 0.12 },
      { playerId: 'away-9', to: { x: 39, y: 32 }, startDelay: 0.16 },
      { playerId: 'away-5', to: { x: 59, y: 62 }, startDelay: 0.22 },
      { playerId: 'away-4', to: { x: 48, y: 63 }, startDelay: 0.28 },
    ],
    duration: 0.5,
  },
  {
    id: 'zone-3-press',
    cue: 'First defender — #7 curves the sprint, then decelerates under CONTROL & RESTRAINT to DENY the forward lane without diving in.',
    ballFrom: { x: 68.5, y: 55 },
    ballTo: { x: 69.5, y: 53.5 },
    ballFromPlayerId: 'away-2',
    ballToPlayerId: 'away-2',
    playerId: 'home-7',
    playerTo: { x: 63, y: 60 },
    facingAngle: 135,
    playerMoves: [
      { playerId: 'away-2', to: { x: 68, y: 53.5 }, facingAngle: 125 },
      { playerId: 'away-7', to: { x: 74, y: 38 }, facingAngle: 145, startDelay: 0.08 },
      { playerId: 'away-8', to: { x: 57, y: 50 }, facingAngle: 155, startDelay: 0.14 },
    ],
    duration: 0.44,
  },
  {
    id: 'zone-3-cover',
    cue: 'CONTROLLED DELAY — #7 stays half-turned and matches the carrier’s speed while #10 locks Channel 2 and DIRECTS play away from goal.',
    ballFrom: { x: 69.5, y: 53.5 },
    ballTo: { x: 70.5, y: 51.5 },
    ballFromPlayerId: 'away-2',
    ballToPlayerId: 'away-2',
    playerId: 'home-10',
    playerTo: { x: 54, y: 53 },
    facingAngle: 95,
    playerMoves: [
      { playerId: 'home-7', to: { x: 65.5, y: 56.5 }, facingAngle: 135 },
      { playerId: 'away-2', to: { x: 69, y: 51.5 }, facingAngle: 150, startDelay: 0.04 },
      { playerId: 'away-7', to: { x: 75, y: 36.5 }, facingAngle: 150, startDelay: 0.08 },
      { playerId: 'away-8', to: { x: 58, y: 48.5 }, facingAngle: 160, startDelay: 0.12 },
    ],
    duration: 0.4,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-8', to: { x: 47, y: 55 }, startDelay: 0.07 },
      { playerId: 'home-9', to: { x: 35, y: 60 }, startDelay: 0.15 },
    ],
    duration: 0.44,
  },
  {
    ...
    playerTo: { x: 24, y: 62 },
    playerMoves: [
      { playerId: 'home-5', to: { x: 51, y: 24 }, startDelay: 0.06 },
      { playerId: 'home-4', to: { x: 38, y: 24 }, startDelay: 0.12 },
      { playerId: 'home-2', to: { x: 64, y: 29 }, startDelay: 0.18 },
      { playerId: 'home-3', to: { x: 24, y: 27 }, startDelay: 0.24 },
      { playerId: 'home-1', to: { x: 50, y: 7 }, startDelay: 0.26 },
    ],
    duration: 0.42,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 55, y: 56 }, startDelay: 0.02 },
      { playerId: 'away-5', to: { x: 58, y: 66 }, startDelay: 0.04 },
      { playerId: 'away-4', to: { x: 47, y: 67 }, startDelay: 0.06 },
      { playerId: 'away-3', to: { x: 32, y: 68 }, startDelay: 0.1 },
    ],
    duration: 0.26,
  },
]
...
const zone4Steps: DefensiveTransitionPageStep[] = [
  {
    ...
    cue: 'Canada possession — GK #1 scans the high press before starting the full-pitch buildup.',
    emphasizePlayerId: 'home-1',
    duration: 0.18,
  },
  {
    id: 'zone-4-gk-to-four',
    cue: 'Zone 1 buildup — GK #1 finds #4 as the first presser jumps and Canada opens supporting angles.',
    ballFrom: { x: 51.5, y: 7 },
    ballTo: { x: 43.5, y: 20 },
    ballFromPlayerId: 'home-1',
    ballToPlayerId: 'home-4',
    ...
    playerTo: { x: 42, y: 20 },
    playerMoves: [
      { playerId: 'away-9', to: { x: 46, y: 26 } },
      { playerId: 'away-10', to: { x: 44, y: 47 }, startDelay: 0.04 },
      { playerId: 'home-5', to: { x: 58, y: 24 }, startDelay: 0.08 },
      { playerId: 'away-7', to: { x: 76, y: 42 }, startDelay: 0.1 },
      { playerId: 'home-6', to: { x: 46, y: 42 }, startDelay: 0.12 },
      { playerId: 'home-2', to: { x: 70, y: 40 }, startDelay: 0.14 },
    ],
    duration: 0.3,
  },
  {
    id: 'zone-4-four-to-six',
    cue: 'Zone 2 progression — #4 breaks the first line into #6 while both teams move up behind the pass.',
    ballFrom: { x: 43.5, y: 20 },
    ballTo: { x: 47.5, y: 43 },
    ballFromPlayerId: 'home-4',
    ballToPlayerId: 'home-6',
    playerId: 'home-6',
    playerTo: { x: 46, y: 43 },
    playerMoves: [
      { playerId: 'away-10', to: { x: 48, y: 45 } },
      { playerId: 'home-2', to: { x: 72, y: 48 }, startDelay: 0.03 },
      { playerId: 'away-9', to: { x: 50, y: 38 }, startDelay: 0.04 },
      { playerId: 'away-8', to: { x: 56, y: 54 }, startDelay: 0.05 },
      { playerId: 'home-8', to: { x: 54, y: 59 }, startDelay: 0.08 },
      { playerId: 'away-7', to: { x: 76, y: 50 }, startDelay: 0.09 },
      { playerId: 'home-7', to: { x: 80, y: 74 }, startDelay: 0.1 },
      { playerId: 'home-3', to: { x: 33, y: 38 }, startDelay: 0.11 },
      { playerId: 'away-5', to: { x: 59, y: 72 }, startDelay: 0.12 },
      { playerId: 'away-4', to: { x: 43, y: 71 }, startDelay: 0.14 },
    ],
    duration: 0.3,
  },
  {
    id: 'zone-4-six-to-eight',
    cue: 'Zone 3 progression — #6 finds #8 between lines as Canada advances its rest-defence and grey retreats compactly.',
    ballFrom: { x: 47.5, y: 43 },
    ballTo: { x: 55.5, y: 59 },
    ballFromPlayerId: 'home-6',
    ballToPlayerId: 'home-8',
    playerId: 'home-8',
    playerTo: { x: 54, y: 59 },
    playerMoves: [
      { playerId: 'away-8', to: { x: 56, y: 58 } },
      { playerId: 'home-2', to: { x: 72, y: 58 }, startDelay: 0.03 },
      { playerId: 'away-9', to: { x: 52, y: 52 }, startDelay: 0.04 },
      { playerId: 'away-6', to: { x: 51, y: 64 }, startDelay: 0.05 },
      { playerId: 'home-4', to: { x: 44, y: 32 }, startDelay: 0.06 },
      { playerId: 'away-10', to: { x: 50, y: 55 }, startDelay: 0.07 },
      { playerId: 'home-10', to: { x: 48, y: 74 }, startDelay: 0.08 },
      { playerId: 'home-5', to: { x: 58, y: 34 }, startDelay: 0.09 },
      { playerId: 'away-7', to: { x: 75, y: 58 }, startDelay: 0.1 },
      { playerId: 'home-9', to: { x: 54, y: 84 }, startDelay: 0.1 },
      { playerId: 'away-2', to: { x: 71, y: 72 }, startDelay: 0.12 },
      { playerId: 'away-5', to: { x: 59, y: 75 }, startDelay: 0.14 },
    ],
    duration: 0.3,
  },
  {
    id: 'zone-4-eight-carry',
    cue: 'Late Zone 3 entry — #8 carries forward as #2 overlaps and #7 holds the width.',
    ballFrom: { x: 55.5, y: 59 },
    ballTo: { x: 60.5, y: 70 },
    ballFromPlayerId: 'home-8',
    ballToPlayerId: 'home-8',
    playerId: 'home-8',
    playerTo: { x: 59, y: 70 },
    playerMoves: [
      { playerId: 'away-2', to: { x: 72, y: 75 } },
      { playerId: 'home-2', to: { x: 74, y: 68 }, startDelay: 0.02 },
      { playerId: 'away-6', to: { x: 53, y: 69 }, startDelay: 0.04 },
      { playerId: 'away-9', to: { x: 52, y: 66 }, startDelay: 0.05 },
      { playerId: 'away-10', to: { x: 49, y: 66 }, startDelay: 0.06 },
      { playerId: 'away-5', to: { x: 60, y: 76 }, startDelay: 0.08 },
      { playerId: 'away-7', to: { x: 74, y: 66 }, startDelay: 0.1 },
      { playerId: 'away-4', to: { x: 44, y: 75 }, startDelay: 0.12 },
    ],
    duration: 0.28,
  },
  {
    id: 'zone-4-eight-releases-seven',
    cue: 'Canada entry — #8 releases #7 into Zone 4 while #2 continues beyond to fix the wide defender.',
    ballFrom: { x: 60.5, y: 70 },
    ballTo: { x: 81.5, y: 82 },
    ballFromPlayerId: 'home-8',
    ...
    playerTo: { x: 80, y: 82 },
    playerMoves: [
      { playerId: 'away-2', to: { x: 74, y: 81 } },
      { playerId: 'home-2', to: { x: 76, y: 88 }, startDelay: 0.02 },
      { playerId: 'away-6', to: { x: 55, y: 75 }, startDelay: 0.04 },
      { playerId: 'away-9', to: { x: 51, y: 78 }, startDelay: 0.05 },
      { playerId: 'away-10', to: { x: 47, y: 74 }, startDelay: 0.06 },
      { playerId: 'away-5', to: { x: 61, y: 80 }, startDelay: 0.08 },
      { playerId: 'away-7', to: { x: 73, y: 72 }, startDelay: 0.1 },
      { playerId: 'away-4', to: { x: 45, y: 78 }, startDelay: 0.12 },
    ],
    duration: 0.28,
  },
  {
    id: 'zone-4-seven-to-ten',
    cue: 'Canada buildup — #7 plays inside to #10 while #2 stays beyond and the grey cover arrives in layers.',
    ballFrom: { x: 81.5, y: 82 },
    ballTo: { x: 48.5, y: 81 },
    ...
    playerTo: { x: 47, y: 81 },
    playerMoves: [
      { playerId: 'away-2', to: { x: 76, y: 82 } },
      { playerId: 'away-10', to: { x: 45, y: 79 }, startDelay: 0.03 },
      { playerId: 'away-6', to: { x: 54, y: 76 }, startDelay: 0.06 },
      { playerId: 'away-9', to: { x: 51, y: 83 }, startDelay: 0.08 },
      { playerId: 'away-5', to: { x: 60, y: 80 }, startDelay: 0.1 },
      { playerId: 'away-3', to: { x: 34, y: 77 }, startDelay: 0.14 },
    ],
    duration: 0.3,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 58, y: 80 }, startDelay: 0.04 },
      { playerId: 'away-5', to: { x: 59, y: 79 }, startDelay: 0.08 },
      { playerId: 'away-4', to: { x: 44, y: 78 }, startDelay: 0.12 },
    ],
    duration: 0.28,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-8', to: { x: 59, y: 78 }, startDelay: 0.03 },
      { playerId: 'away-6', to: { x: 52, y: 72 }, startDelay: 0.06 },
      { playerId: 'away-4', to: { x: 43, y: 77 }, startDelay: 0.1 },
    ],
    duration: 0.26,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-6', to: { x: 50, y: 66 }, startDelay: 0.06 },
      { playerId: 'away-10', to: { x: 45, y: 75 }, startDelay: 0.1 },
      { playerId: 'away-2', to: { x: 74, y: 72 }, startDelay: 0.16 },
      { playerId: 'away-5', to: { x: 61, y: 70 }, startDelay: 0.24 },
    ],
    duration: 0.5,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-6', to: { x: 46, y: 61 }, startDelay: 0.08 },
      { playerId: 'home-8', to: { x: 55, y: 64 }, startDelay: 0.16 },
      { playerId: 'home-2', to: { x: 72, y: 72 }, startDelay: 0.24 },
    ],
    duration: 0.46,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-4', to: { x: 43, y: 49 }, startDelay: 0.04 },
      { playerId: 'home-2', to: { x: 66, y: 55 }, startDelay: 0.08 },
      { playerId: 'home-3', to: { x: 34, y: 55 }, startDelay: 0.12 },
      { playerId: 'home-1', to: { x: 50, y: 7 }, startDelay: 0.16 },
    ],
    duration: 0.32,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-10', to: { x: 45, y: 79 }, startDelay: 0.02 },
      { playerId: 'away-5', to: { x: 60, y: 72 }, startDelay: 0.04 },
      { playerId: 'away-4', to: { x: 46, y: 72 }, startDelay: 0.06 },
      { playerId: 'away-2', to: { x: 73, y: 74 }, startDelay: 0.08 },
      { playerId: 'away-3', to: { x: 32, y: 74 }, startDelay: 0.1 },
    ],
    duration: 0.26,
  },
]
...
const zone1Routes: PixiPitchPreviewRoute[] = [
  ...
  { id: 'zone-1-ten-recovery', from: { x: 50, y: 57 }, to: { x: 50, y: 46 }, type: 'recovery', revealOnStepId: 'zone-1-central-cover' },
...
const zone3Routes: PixiPitchPreviewRoute[] = [
  ...
  { id: 'zone-3-turnover', from: { x: 44.5, y: 58 }, to: { x: 65.5, y: 63 }, type: 'pass', revealOnStepId: 'zone-3-loss' },
  { id: 'zone-3-counter-dribble', from: { x: 65.5, y: 63 }, to: { x: 68.5, y: 55 }, type: 'dribble', revealOnStepId: 'zone-3-counter-intent' },
  { id: 'zone-3-press-route', from: { x: 59, y: 80 }, to: { x: 63, y: 60 }, type: 'press', revealOnStepId: 'zone-3-press' },
  { id: 'zone-3-carrier-tests-press', from: { x: 68.5, y: 55 }, to: { x: 69.5, y: 53.5 }, type: 'dribble', revealOnStepId: 'zone-3-press' },
  { id: 'zone-3-control-restraint', from: { x: 63, y: 60 }, to: { x: 65.5, y: 56.5 }, type: 'press', revealOnStepId: 'zone-3-cover' },
  { id: 'zone-3-carrier-directed-wide', from: { x: 69.5, y: 53.5 }, to: { x: 70.5, y: 51.5 }, type: 'dribble', revealOnStepId: 'zone-3-cover' },
  { id: 'zone-3-lock-route', from: { x: 43, y: 62 }, to: { x: 54, y: 53 }, type: 'recovery', revealOnStepId: 'zone-3-cover' },
...
const zone4Routes: PixiPitchPreviewRoute[] = [
  { id: 'zone-4-gk-pass', from: { x: 51.5, y: 7 }, to: { x: 43.5, y: 20 }, type: 'pass', revealOnStepId: 'zone-4-gk-to-four' },
  { id: 'zone-4-six-connection', from: { x: 43.5, y: 20 }, to: { x: 47.5, y: 43 }, type: 'pass', revealOnStepId: 'zone-4-four-to-six' },
  { id: 'zone-4-eight-connection', from: { x: 47.5, y: 43 }, to: { x: 55.5, y: 59 }, type: 'pass', revealOnStepId: 'zone-4-six-to-eight' },
  { id: 'zone-4-eight-carry', from: { x: 55.5, y: 59 }, to: { x: 60.5, y: 70 }, type: 'dribble', revealOnStepId: 'zone-4-eight-carry' },
  { id: 'zone-4-two-overlap', from: { x: 68, y: 34 }, to: { x: 76, y: 88 }, type: 'run', revealOnStepId: 'zone-4-eight-releases-seven' },
  { id: 'zone-4-eight-release', from: { x: 60.5, y: 70 }, to: { x: 81.5, y: 82 }, type: 'pass', revealOnStepId: 'zone-4-eight-releases-seven' },
  { id: 'zone-4-wide-inside', from: { x: 81.5, y: 82 }, to: { x: 48.5, y: 81 }, type: 'pass', revealOnStepId: 'zone-4-seven-to-ten' },
  ...
  { id: 'zone-4-wide-delay', from: { x: 80, y: 82 }, to: { x: 70, y: 78 }, type: 'recovery', revealOnStepId: 'zone-4-delay' },
  { id: 'zone-4-two-recovery', from: { x: 76, y: 88 }, to: { x: 72, y: 72 }, type: 'recovery', revealOnStepId: 'zone-4-delay' },
...
export const DEFENSIVE_TRANSITION_PAGE_CASES: DefensiveTransitionPageCase[] = [
  {
    ...
    caption: 'Canada builds from GK #1 through #4 and #5 before the Zone 1 interception. Away #10 drives, #3 applies DELAY, #6/#8 protect centrally, and #10/#9 recover into separate screens.',
    ...
    tactics: ['Canada possession/loss: GK #1 connects #4 to #5 before the central interception.', 'First defender: #3 delays the forward touch without diving in.', 'Cover and balance: #6/#8 protect goal-side while #10/#9 recover into separate screens.', 'Recovery outcome: the back line protects goal and GK #1 stays set.'],
    coachingPoints: ['Arrive under control, show away from goal, and delay the next action.', '#6/#8 protect different depths; #10 recovers centrally and #9 screens the next outlet.'],
  ...
  },
  {
    ...
    caption: 'Canada builds from GK #1 through #5, #6, and #8 before the Zone 3 supply loss. #7 curves, decelerates, and stays half-turned under CONTROL & RESTRAINT; #10 DIRECTS outside, #6/#8 protect different depths, and #9 drops.',
    ...
    tactics: ['Canada possession/loss: GK #1 connects #5, #6, and #8 before the supply interception.', 'First defender: #7 sprints on the cue, curves the approach, then reduces speed over the final metres to stay balanced and goal-side.', 'Control and cover: #7 remains half-turned and matches the carrier while #10 locks inside, #6/#8 stagger, and #9 drops.', 'Recovery outcome: the carrier is directed outside, #11 delays the wide option, and rest-defence protects Zone 1/2.'],
    coachingPoints: ['#7 arrives fast but not reckless: shorten the final steps, hips half-open, eyes on ball and runner, no lunge.', '#10 protects a separate inside lane; #6/#8 stagger behind pressure while #9 recovers toward halfway.'],
    principles: ['DENY', 'DELAY', 'BALANCE', 'CONTROL & RESTRAINT'],
  ...
  },
  {
    ...
    caption: 'Canada builds from GK #1 through #4, #6, and #8 while both teams move through the thirds. #8 carries and releases #7 with #2 overlapping, then #7 combines through #10 and #9 before the Zone 4 cutback is intercepted.',
    ...
    tactics: ['Canada buildup/loss: GK #1 connects #4, #6, and #8 as the team advances, then #8 releases #7 with #2 beyond before the #7–#10–#9–#10 combination and intercepted cutback.', 'First defender: #9 pressures beside the attempted outlet and denies progression.', 'Cover and balance: #10 and #7 occupy separate lanes while #6/#8 secure.', 'Recovery outcome: rest-defence protects the escape and recovers compactly.'],
