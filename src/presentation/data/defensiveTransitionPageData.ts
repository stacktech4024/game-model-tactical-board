...
const zone1Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-6', to: { x: 43, y: 53 } },
      { playerId: 'away-3', to: { x: 28, y: 74 } },
      { playerId: 'away-4', to: { x: 42, y: 72 } },
      { playerId: 'away-5', to: { x: 58, y: 72 } },
      { playerId: 'away-2', to: { x: 72, y: 74 } },
    ],
    duration: 0.42,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-6', to: { x: 44, y: 43 } },
      { playerId: 'away-8', to: { x: 58, y: 32 } },
      { playerId: 'away-3', to: { x: 30, y: 70 } },
      { playerId: 'away-4', to: { x: 44, y: 68 } },
      { playerId: 'away-5', to: { x: 60, y: 68 } },
      { playerId: 'away-2', to: { x: 74, y: 70 } },
    ],
    duration: 0.42,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 32, y: 66 } },
      { playerId: 'away-4', to: { x: 45, y: 64 } },
      { playerId: 'away-5', to: { x: 60, y: 64 } },
      { playerId: 'away-2', to: { x: 75, y: 66 } },
    ],
    duration: 0.5,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'home-10', to: { x: 50, y: 46 }, startDelay: 0.06 },
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 30, y: 71 } },
      { playerId: 'away-4', to: { x: 44, y: 69 } },
      { playerId: 'away-5', to: { x: 59, y: 69 } },
      { playerId: 'away-2', to: { x: 74, y: 71 } },
    ],
    duration: 0.26,
  },
]
...
const zone2Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 28, y: 75 } },
      { playerId: 'away-4', to: { x: 42, y: 73 } },
      { playerId: 'away-5', to: { x: 58, y: 73 } },
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 30, y: 70 } },
      { playerId: 'away-4', to: { x: 44, y: 68 } },
      { playerId: 'away-5', to: { x: 59, y: 68 } },
      { playerId: 'away-2', to: { x: 73, y: 70 } },
    ],
    duration: 0.42,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 32, y: 65 } },
      { playerId: 'away-4', to: { x: 45, y: 63 } },
      { playerId: 'away-5', to: { x: 60, y: 63 } },
      { playerId: 'away-2', to: { x: 74, y: 65 } },
    ],
    duration: 0.5,
  },
  {
...
const zone3Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 28, y: 76 } },
      { playerId: 'away-4', to: { x: 43, y: 75 } },
      { playerId: 'away-5', to: { x: 58, y: 75 } },
    ],
    duration: 0.38,
  },
  {
    id: 'zone-3-five-to-six',
    cue: 'Canada buildup — #5 connects with #6 as away #2 narrows and the back line shifts together.',
    ...
    playerTo: { x: 34, y: 48 },
    playerMoves: [
      { playerId: 'away-2', to: { x: 68, y: 71 } },
      { playerId: 'away-6', to: { x: 38, y: 64 } },
      { playerId: 'away-9', to: { x: 37, y: 35 } },
      { playerId: 'away-3', to: { x: 29, y: 73 } },
      { playerId: 'away-4', to: { x: 44, y: 72 } },
      { playerId: 'away-5', to: { x: 59, y: 72 } },
    ],
    duration: 0.4,
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 31, y: 70 } },
      { playerId: 'away-4', to: { x: 46, y: 69 } },
      { playerId: 'away-5', to: { x: 61, y: 69 } },
    ],
    duration: 0.4,
  },
  {
    ...
    playerTo: { x: 64, y: 63 },
    playerMoves: [
      { playerId: 'away-3', to: { x: 32, y: 68 } },
      { playerId: 'away-4', to: { x: 47, y: 67 } },
      { playerId: 'away-5', to: { x: 58, y: 66 } },
    ],
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 34, y: 64 } },
      { playerId: 'away-4', to: { x: 48, y: 63 } },
      { playerId: 'away-5', to: { x: 59, y: 62 } },
    ],
    duration: 0.5,
  },
  {
  ...
  },
  {
    ...
    playerTo: { x: 24, y: 62 },
    playerMoves: [
      { playerId: 'home-2', to: { x: 64, y: 29 } },
      { playerId: 'home-3', to: { x: 24, y: 27 } },
      { playerId: 'home-4', to: { x: 38, y: 24 } },
      { playerId: 'home-5', to: { x: 51, y: 24 } },
      { playerId: 'home-1', to: { x: 50, y: 7 } },
    ],
    duration: 0.42,
  },
...
const zone4Steps: DefensiveTransitionPageStep[] = [
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-3', to: { x: 33, y: 70 } },
      { playerId: 'away-4', to: { x: 47, y: 68 } },
      { playerId: 'away-5', to: { x: 61, y: 68 } },
    ],
    duration: 0.5,
  },
  {
  ...
  },
  {
    ...
    playerMoves: [
      ...
      { playerId: 'away-10', to: { x: 45, y: 79 } },
      { playerId: 'away-3', to: { x: 32, y: 74 } },
      { playerId: 'away-4', to: { x: 46, y: 72 } },
      { playerId: 'away-5', to: { x: 60, y: 72 } },
      { playerId: 'away-2', to: { x: 73, y: 74 } },
    ],
    duration: 0.26,
  },
]
